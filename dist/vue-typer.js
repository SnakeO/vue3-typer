/*!
 * vue-typer v1.2.0
 * Copyright 2016-2023 Chris Nguyen
...
var _VueTyper = __webpack_require__(31);
...
var _isFinite = __webpack_require__(40);

var _isFinite2 = _interopRequireDefault(_isFinite);

var _isNan = __webpack_require__(41);
...
var _randomInt = __webpack_require__(33);
...
var _Caret = __webpack_require__(79);

var _Caret2 = _interopRequireDefault(_Caret);

var _Char = __webpack_require__(80);

var _Char2 = _interopRequireDefault(_Char);

var _shallowEquals = __webpack_require__(34);

var _shallowEquals2 = _interopRequireDefault(_shallowEquals);

var _shuffle = __webpack_require__(35);
...
exports.default = {
  ...
  computed: {
    leftWords: function leftWords() {
      return this.currentText.slice(0, this.currentTextIndex).split(' ').map(function (word, index, array) {
        return index < array.length - 1 ? [].concat((0, _toConsumableArray3.default)(word.split('')), [' ']) : word.split('');
      });
    },
    rightWords: function rightWords() {
      return this.currentText.slice(this.currentTextIndex).split(' ').map(function (word, index, array) {
        return index < array.length - 1 ? [].concat((0, _toConsumableArray3.default)(word.split('')), [' ']) : word.split('');
      });
    },
...
// module
exports.push([module.i, "@keyframes vue-typer-caret-blink{50%{opacity:0}to{opacity:1}}@keyframes vue-typer-caret-smooth{0%,20%{opacity:1}60%,to{opacity:0}}@keyframes vue-typer-caret-phase{0%,20%{opacity:1}90%,to{opacity:0}}@keyframes vue-typer-caret-expand{0%,20%{transform:scaleY(1)}80%,to{transform:scaleY(0)}}.vue-typer-caret-blink[data-v-4ebf634c]{animation:vue-typer-caret-blink 1s step-start 0s infinite}.vue-typer-caret-smooth[data-v-4ebf634c]{animation:vue-typer-caret-smooth .5s ease-in-out 0s infinite alternate}.vue-typer-caret-phase[data-v-4ebf634c]{animation:vue-typer-caret-phase .5s ease-in-out 0s infinite alternate}.vue-typer-caret-expand[data-v-4ebf634c]{animation:vue-typer-caret-expand .5s ease-in-out 0s infinite alternate}span.caret[data-v-4ebf634c]:empty:before{content:\"\\200B\"}span[data-v-4ebf634c]{display:inline-block;width:1px}.idle[data-v-4ebf634c],.typing[data-v-4ebf634c]{background-color:#000}.selecting[data-v-4ebf634c]{display:none;background-color:#000}.erasing[data-v-4ebf634c]{background-color:#000}.complete[data-v-4ebf634c]{display:none;background-color:#000}", ""]);
...
// module
exports.push([module.i, "span.vue-typer[data-v-7348afd9]{cursor:default;-webkit-user-select:none;-ms-user-select:none;user-select:none}span.vue-typer span.left[data-v-7348afd9],span.vue-typer span.right[data-v-7348afd9]{display:inline}span.word[data-v-7348afd9]{white-space:nowrap}", ""]);
...
// module
exports.push([module.i, ".char[data-v-787263c6]{display:inline-block;white-space:pre-wrap}.newline[data-v-787263c6]{display:inline}.typed[data-v-787263c6]{color:#000;background-color:transparent}.selected[data-v-787263c6]{color:#000;background-color:#accef7}.erased[data-v-787263c6]{display:none}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('span', {
    ...
    staticClass: "left"
  }, _vm._l((_vm.leftWords), function(word) {
    return _c('span', {
      key: word,
      staticClass: "word"
    }, _vm._l((word), function(char) {
      return _c('char', {
...
var update = __webpack_require__(19)("14f7bfd0", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(19)("69b7920e", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(19)("3d780410", content, true);
